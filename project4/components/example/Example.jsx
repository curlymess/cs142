...
class Example extends React.Component {
  ...
  // Method called when motto text box is typed into
    ...
    return (
      <div className="container Example">
        ...
        <div className="motto-update">
          ...
          <p>{this.state.name}</p>
          <textarea cols="30" rows="1" value={this.state.motto} onChange={this.handleChangeMotto}>{this.state.motto}</textarea></>          
          }
        </div>
